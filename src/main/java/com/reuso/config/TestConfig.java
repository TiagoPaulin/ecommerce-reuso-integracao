...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Evento e1 = new Evento(null, "Brasil x Equador", "2024-11-10", "18:30", te1);
		Evento e2 = new Evento(null, "ExpoCampi 2024", "2024-10-27", "12:30", te2);
		...
		PessoaJuridica pj1 = (PessoaJuridica) UsuarioFactory.createUser("j", "Gabriel Felipe Jess Meira", "bibo@gmail.com", "senha123","", "81.243.735/0019-77");
